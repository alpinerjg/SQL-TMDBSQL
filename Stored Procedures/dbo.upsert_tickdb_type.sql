...
-- ============================================= 
CREATE PROCEDURE [dbo].[upsert_tickdb_type] @bbsecurity    VARCHAR(32), 
                                            @type          CHAR(1), 
                                            @src           VARCHAR(15), 
                                            @value         DECIMAL(12, 6), 
                                            @delayed       BIT, 
...
AS 
  BEGIN 
      ...
      -- Occasionally @ts is coming in as 0001-01-01 00:00:00.0000000   :-(
	  IF ( @ts < DATEADD(DAY,-7,Sysdatetime()) )
	    SET @ts = @tsbb
