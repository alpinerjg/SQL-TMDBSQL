...
-- ============================================= 
CREATE PROCEDURE [dbo].[upsert_tickdb_type_qa] @bbsecurity    VARCHAR(32), 
                                            @type          CHAR(1), 
                                            @src           VARCHAR(15), 
                                            @value         DECIMAL(12, 6), 
                                            @delayed       BIT, 
        ...
        BEGIN 
            BEGIN try 
                  ...
                  BEGIN 
                      ...
                      IF EXISTS(SELECT 1 
                                ...
                                WHERE  bbsecurity = @bbsecurity 
                                       ...
                                       AND tsbb < @tsbb) 
                        BEGIN 
                            UPDATE dbo.tickdb_type_qa WITH (serializable) 
                            SET    value = @value, 
                                   delayed = @delayed,
                ...
                ELSE 
                  BEGIN 
                      -- new record 
                      INSERT INTO dbo.tickdb_type_qa 
                                  (bbsecurity, 
                                   type, 
                                   src, 
                                   value, 
