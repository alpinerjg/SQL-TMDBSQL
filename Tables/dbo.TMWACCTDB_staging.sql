CREATE TABLE [dbo].[TMWACCTDB_staging]
(
...
GO
ALTER TABLE [dbo].[TMWACCTDB_staging] ADD CONSTRAINT [PK_TMWACCTDB_staging] PRIMARY KEY CLUSTERED ([account]) WITH (FILLFACTOR=90, PAD_INDEX=ON) ON [PRIMARY]
GO
