...
[RecoveryModel] [varchar] (12) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
...
GO
ALTER TABLE [Minion].[IndexSettingsDB] ADD CONSTRAINT [ckRebuildGTReorg] CHECK (([RebuildThreshold]>[ReorgThreshold]))
GO
