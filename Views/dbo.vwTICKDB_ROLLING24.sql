...
CREATE VIEW [dbo].[vwTICKDB_ROLLING24]
AS
SELECT			bbsecurity, 
				type, 
				src, 
...
Begin DesignProperties = 
   ...
   End
End
', 'SCHEMA', N'dbo', 'VIEW', N'vwTICKDB_ROLLING24', NULL, NULL
GO
DECLARE @xp int
SELECT @xp=1
EXEC sp_addextendedproperty N'MS_DiagramPaneCount', @xp, 'SCHEMA', N'dbo', 'VIEW', N'vwTICKDB_ROLLING24', NULL, NULL
GO
